  ...
  return (
    <Paper elevation={24} sx={{
      ...
      <Box mt={3} sx={{ textAlign: "left" }}>
        ...
        <Typography variant='h4' sx={{ color: "white", fontWeight: "800", lineHeight: "44px", fontSize: "29px", marginBottom: "1rem" }}>Umar Draz Khan</Typography>
        <Typography sx={{ color: "white", fontWeight: "600", lineHeight: "1.5rem", marginBottom: "2rem" }}>Full Stack Developer</Typography>
        ...
        <Typography variant='subtitle2' sx={{ color: "white", lineHeight: "1.5rem", marginBottom: "2rem" }}>
          Email : <span> drazumar277@gmail.com</span>
        </Typography>
